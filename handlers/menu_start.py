...
async def start(message: types.Message):
    ...
    message_obj = await bot.send_message(
        ...
        text=f"<b>Привет!</b> 👋😃\n"
             ...
             f"<blockquote>Нейросеть обучена на отечественных и зарубежных исследованиях специалистов по питанию, врачей-нутрициологов, диетологов и гастроэнтерологов 🫶🧑⚕️</blockquote>"
             f"\n"
             f"\n"
