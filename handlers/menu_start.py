...
async def start(message: types.Message):
    ...
    if db.check_client(user):
        message_obj = await bot.send_message(
            ...
            text=f"<b>Привет!</b> 👋\n"
                    f"\n"
                    f"На связи ✨<b>food2mood</b>✨ - <u>сервис персональных рекомендаций блюд под настроение! </u> 😃🍽️\n\n"
                    ...
                    f"👉<b>Мы помним тебя, друг!\n</b> Ты можешь получать рекомендации сразу или обновить информацию в анкете📝\n"
                    f"\n",
            parse_mode='HTML',
