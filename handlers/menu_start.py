...
async def start(message: types.Message):
    ...
    message_obj = await bot.send_message(
        ...
        text=f"<b>Привет!</b> 👋😃\n"
             ...
             f"<b>Food2mood</b> обучена на исследованиях специалистов по питанию. Она анализирует меню заведения и составляет подборки специально для тебя!❤️️\n\n"
             f"А еще <b>food2mood</b> умеет находить заведения под настроение🔍\n"
